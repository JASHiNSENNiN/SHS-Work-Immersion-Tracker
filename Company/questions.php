...
<body>
    ...
    <div class="bgc">
        ...
        <div class="snapshot_container">
            <h1 style="font-size: 1.2rem; margin:0%; margin: bottom 20px; margin-block-end: 1rem;">Questions and Answers about NATIONAL IRRIGATION ADMINISTRATION (NIA)</h1>
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="box-top">
                            ...
                            <div class="profile">
                                ...
                                <!--name-and-username-->
                                <div class="name-user">
                                    <a><strong>How long do you have to work at NATIONAL IRRIGATION ADMINISTRATION (NIA) before you can go on maternity leave?</strong></a>
                    ...
                    <div class="testimonial-box">
                        ...
                        <div class="box-top">
                            ...
                            <div class="profile">
                                ...
                                <!--name-and-username-->
                                <div class="name-user">
                                    <a><strong>What benefits does NATIONAL IRRIGATION ADMINISTRATION (NIA) offer?</strong></a>
