...
function fetch_user_profile($conn, $user_id)
{
...
function fetch_student_profile($conn, $user_id)
{
...
function fetch_school_profile($conn, $user_id)
{
...
function fetch_partner_profile($conn, $user_id)
{
...
if ($user_profile['account_type'] === 'student') {
    $student_profile = fetch_student_profile($conn, $user_id);
    ...
    $school_profile = fetch_school_profile($conn, $user_id);
    ...
    $partner_profile = fetch_partner_profile($conn, $user_id);
