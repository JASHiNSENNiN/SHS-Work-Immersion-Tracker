    ...
    <div class="row">
        ...
        <div id="login-form" class="colm-form">
            ...
            <div class="form-container">
                ...
                <!-- --------------------------------Line OR--------------------------->
                <form id="loginForm" method="POST" onsubmit="">
                    ...
                    <button class="g-recaptcha btn-login" data-sitekey="6Lfa9MIpAAAAALAoYvFEZ86D6SvXCMeXjJ1ULag6"
                        data-callback='onSubmit' data-action='login_form_submit' style="height: 40px; font-size: 15px">
        ...
        <div id="register-form" class="colm-form">
            ...
            <div class="form-container">
                ...
                <form id="registerForm" action="one_time_password.php" method="POST"
                    ...
                    <button type="submit" class="g-recaptcha btn-login"
                        data-sitekey="6Lfa9MIpAAAAALAoYvFEZ86D6SvXCMeXjJ1ULag6" data-callback='onSubmit'
                        data-action='register_form_submit'>Register</button>
                </form>
