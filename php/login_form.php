    ...
    <div class="row">
        ...
        <div id="login-form" class="colm-form">
            ...
            <div class="form-container">
                ...
                <!-- --------------------------------Line OR--------------------------->
                <form method="POST" onsubmit="return validateForm()" action="<?php echo $_SERVER['DOCUMENT_ROOT'] . '/backend/php/recaptcha.php' ?>">
                    ...
                    <input <button class="g-recaptcha" data-sitekey="6Lfa9MIpAAAAALAoYvFEZ86D6SvXCMeXjJ1ULag6" data-callback='onSubmit' data-action='login_form_submit' class="btn-login" style="height: 40px; font-size: 15px"> <span class="hover-underline-animation"> Continue </span>
        ...
        <div id="register-form" class="colm-form">
            ...
            <div class="form-container">
                ...
                <form id="registerForm" action="one_time_password.php" method="POST" onsubmit="return validateRegisterForm()">
                    ...
                    <button class="g-recaptcha" data-sitekey="6Lfa9MIpAAAAALAoYvFEZ86D6SvXCMeXjJ1ULag6" data-callback='onSubmit' data-action='register_form_submit' type="submit" class="btn-login" onclick="">Register</button>
