...
<head>
    ...
    <script src="<?php echo $_SERVER['DOCUMENT_ROOT'] ?>/backend/js/login.js"></script>
    <script src="<?php echo $_SERVER['DOCUMENT_ROOT'] ?>/backend/js/register.js"></script>
    ...
    <div class="row">
        ...
        <div id="login-form" class="colm-form">
            ...
            <div class="form-container">
                ...
                <!-- --------------------------------Line OR--------------------------->
                <form id="loginForm" method="POST" onsubmit="return validateForm()" action="<?php echo $_SERVER['DOCUMENT_ROOT'] . '/backend/php/recaptcha.php' ?>">
                    ...
                    <button class="g-recaptcha btn-login" data-sitekey="6Lfa9MIpAAAAALAoYvFEZ86D6SvXCMeXjJ1ULag6" data-callback='onSubmit' data-action='login_form_submit' style="height: 40px; font-size: 15px">
                        ...
                        <svg id="arrow-horizontal" xmlns="http://www.w3.org/2000/svg" width="30" height="10" viewBox="0 0 46 16" fill="#fff">
                            <path id="Path_10" data-name="Path 10" form d="M8,0,6.545,1.455l5.506,5.506H-30V9.039H12.052L6.545,14.545,8,16l8-8Z" transform="translate(30)"></path>
                            g>
                    </button>
                </form>
        ...
        <div id="register-form" class="colm-form">
            ...
            <div class="form-container">
                ...
                <form id="registerForm" action="one_time_password.php" method="POST" onsubmit="return validateRegisterForm()">
                    ...
                    <button class="g-recaptcha btn-login" data-sitekey="6Lfa9MIpAAAAALAoYvFEZ86D6SvXCMeXjJ1ULag6" data-callback='onSubmit' data-action='register_form_submit' type="submit">Register</button>
