            ...
            <div id="login-form" class="colm-form">
                <div class="form-container">
                    <input autocomplete="email" type="text"
                        placeholder="Email address" id="login-email" name="login-email">
                    <input autocomplete="current-password" type="password" placeholder="Password" id="login-password" name="login-password">
                    <button class="btn-login" onclick="login()">Login</button>
                    <button class="btn-new" id="switch-to-register"
                        onclick="showLoginForm()">Create New
                        Account</button>
                </div>
            </div>
